...
- [Engineering](engineering/README.md)
  ...
  - [Architecture Decision Records](engineering/adr/README.md)
    ...
    - [Proposed]()
      - [0010 - Adopt project-wide Repository pattern](engineering/adr/0010-adopt-project-wide-repository-pattern.md)
    - [Accepted]()
      ...
      - [0009 - Feature/Core API/Internal split and dependency rules](engineering/adr/0009-api-internal-split.md)
    - [Rejected]()
    - [Obsolete]()
