...
/**
 * Bitmask of allowed authenticator types for BiometricPrompt and availability checks.
 *
 * Accepts strong biometrics, weak biometrics, and device credentials (PIN/pattern/password).
 */
